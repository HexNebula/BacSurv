...
export function StreamForm({
  ...
  const { sessionsHere } = useWorkspace()
  ...
  // disagreed once. Found by id rather than taken from the chosen session,
  // since this form is opened for one session in particular
  const level = sessionsHere.find((one) => one.id === sessionId)?.level ?? null
